...
////                .frameOptions(frameOptions -> frameOptions.disable())  // X-Frame-Options 설정
////                .cacheControl(cacheControl -> cacheControl.disable())  // 캐싱 방지
...
//                .requestMatchers("/login/oauth2/**").permitAll()  // 추가 필
